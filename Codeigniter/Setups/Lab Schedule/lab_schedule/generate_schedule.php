    ...
    <div class="ibox-content">
        <div class="div-background">
            ...
            <div class="row3">
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="col-md-5 control-label">Start Time:<span class="red">*</span></label>
                        <div class="col-md-5">
                            <div class='input-group date time_picker'>
                                <input required="required" value="<?php echo  set_value("CLASS_START_TIME"); ?>" name="CLASS_START_TIME" id="CLASS_START_TIME" type='text' class="form-control" />
                                <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-time"></span>
                                </span>
                            </div>
                            <span class="red"><?php echo form_error('CLASS_START_TIME'); ?></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="col-md-5 control-label">End Time:<span class="red">*</span></label>
                        <div class="col-md-5">
                            <div class='input-group date time_picker'>
                                <input required="required" value="<?php echo  set_value("CLASS_END_TIME"); ?>" id="CLASS_END_TIME" name="CLASS_END_TIME" type='text' class="form-control" />
                                <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-time"></span>
                                </span>
                            </div>
                            <span class="red"><?php echo form_error('CLASS_END_TIME'); ?></span>
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $(document).on("click","#find_gen_sdl", function () {
        ...
        var url_data = {EXP_ID:EXP_ID,YSESSION_ID:YSESSION_ID, DEGREE_ID:DEGREE_ID, FACULTY_ID:FACULTY_ID, DEPT_ID:DEPT_ID, PROGRAM_ID:PROGRAM_ID, BATCH_ID:BATCH_ID, SECTION_ID:SECTION_ID, CLASS_START_TIME:CLASS_START_TIME,CLASS_END_TIME:CLASS_END_TIME,SDL_DT:SDL_DT};

        $.ajax({

            type: "POST",
            url: "<?=base_url();?>lab_schedule/ajax_student_depent_view",
            data: url_data,
            success:function(data){
    ...
    $(document).on("click", "#submit_gen_sdl", function (e) {
        ...
        $.ajax({
            type: "POST",
            url: "<?=base_url();?>lab_schedule/generate_schedule",
