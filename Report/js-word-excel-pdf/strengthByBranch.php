                            ...
                            <div class="col-md-6">
                                ...
                                <?php $this->load->view('reportViewPrint/common/partII') ?>
                                    <div class="col-md-offset-3 col-md-3">
                                        <input type="checkbox" name="withMisc" value="1" id="WithMisc"> With Misc
                                    </div>
                            </div>
                        </fieldset>
                    </div>
        ...
        if (confirm("Are You Sure?")) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if(rType === 'pdf')
                    {
                        htmlToPdf('aca_tbl','test'); // htmlToPdf(autoTableId='', fileName = '', headerHtmlId = '', footerHtmlId='', otherHtmlId = '' )
                    }

                    if(rType === 'word')
                    {
                        htmlToWord(htmlData); // htmlToWord(html, filename='')
                    }

                    if(rType === 'excel')
                    {
                        htmlToExcel('aca_tbl'); // htmlToExcel(tableId,filename)
                    }
